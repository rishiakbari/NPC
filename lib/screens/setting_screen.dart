...
import 'package:npc/widgets/custom_icon.dart';
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    contentPadding: const EdgeInsets.all(0),
                    leading: const CustomIcon(
                      icon: 'assets/icons/material-notifications-active.svg',
                    ),
                    title: Text(
                      overflow: TextOverflow.ellipsis,
                      'Order Management',
                  ...
                  ListTile(
                    ...
                    contentPadding: const EdgeInsets.all(0),
                    leading: const CustomIcon(
                      icon: 'assets/icons/ionic-md-settings.svg',
                    ),
                    title: Text(
                      overflow: TextOverflow.ellipsis,
                      'Document Management',
                  ...
                  ListTile(
                    ...
                    contentPadding: const EdgeInsets.all(0),
                    leading: const CustomIcon(
                      icon: 'assets/icons/networking-2.svg',
                    ),
                    title: Text(
                      overflow: TextOverflow.ellipsis,
                      'Newsletter',
